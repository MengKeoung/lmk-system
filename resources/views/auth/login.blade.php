...
<body>
    <section class="ftco-section h-100vh">
        <div class="container h-100 d-flex justify-content-center align-items-center w-100">
            <div style="width: min(100%, 750px) !important;"
                class="row py-4 align-items-center justify-content-center bg-white rounded shadow-sm">
                    ...
                    <div class="px-3">
                        ...
                        <h2 class="heading-section d-flex justify-content-center">
                            ...
                            <img src="@if ($web_header_logo && file_exists('uploads/business_settings/' . $web_header_logo)) {{ asset('uploads/business_settings/' . $web_header_logo) }}
                                                            @else
                                                                {{ asset('images/no_image_available.jpg') }} @endif" alt="no logo" class="custom-logo">
                        </h2>
                    </div>
                </div>
                <div class="col-md-7 col-lg-7">
                    <div class="">
                        ...
                        <div class="login-wrap">
                            <div class="d-flex justify-content-center">
                                <div class="">
                                    <h3 class="text-uppercase" style="margin: 0;color:#ff7300;">{{ __('Login') }}</h3>
                                </div>
                            </div>
                            <br>
                    ...
                    <div class="form-group">
                        <button type="submit" class="btn btn-block text-white rounded float-right"
                            style="margin-bottom: 20px; background-color: #ff7300;">{{ __('Log In') }}</button>
                    </div>
                    <br>
                    </form>
                </div>
