...
<head>
    ...
    <title>@yield('page_title', 'Booking Service System')</title>
    <meta name="csrf-token" content="{{ csrf_token() }}" />
    @php
        $fav_icon = \App\Models\BusinessSetting::where('type', 'fav_icon')->first()->value;
    @endphp
    <link rel="icon"
        href=" @if ($fav_icon && file_exists('uploads/business_settings/' . $fav_icon)) {{ asset('uploads/business_settings/' . $fav_icon) }}
                                                                @else
