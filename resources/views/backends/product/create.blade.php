                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-6 ">
                                        ...
                                        <input type="number" class="form-control @error('unit_price') is-invalid @enderror"
                                            value="{{ old('unit_price') }}" name="unit_price"
                                    ...
                                    <div class="form-group col-md-6 ">
                                        ...
                                        <input type="number"
                                            ...
                                            value="{{ old('whole_price') }}" name="whole_price"
                                    ...
                                    <div class="form-group col-md-6 ">
                                        ...
                                        <input type="number" class="form-control @error('inventory') is-invalid @enderror"
                                            value="{{ old('inventory') }}" name="inventory"
                                    ...
                                    <div class="form-group col-md-6 ">
                                        ...
                                        <input type="number" class="form-control @error('low_stock_threshold') is-invalid @enderror"
                                            value="{{ old('low_stock_threshold') }}" name="low_stock_threshold"
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <div class="preview text-center border rounded mt-2" style="height: 150px">
                                            <img src="{{ asset('upload/image/default.png') }}" alt=""
                                                height="100%">
                                        </div>
                                    </div>
