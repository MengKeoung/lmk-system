                                                    ...
                                                    <div class="tab-pane fade {{ $lang['code'] == $default_lang ? 'show active' : '' }} mt-3"
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <input type="name" id="name_{{ $lang['code'] }}"
                                                                ...
                                                                value="{{ $translate[$lang['code']]['name'] ?? $customer['name'] }}">
                                                            @error('name')
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <div class="preview text-center border rounded mt-2" style="height: 150px">
                                            <img src="
                                                @if ($customer->image && file_exists(public_path('upload/customers/' . $customer->image))) {{ asset('upload/customers/' . $customer->image) }}
                                                @else
                                    ...
                                    <div class="form-group col-md-12">
                                        <label>{{ __('Note') }}</label>
                                        <textarea class="form-control @error('note') is-invalid @enderror" name="note">{{ old('note', $customer->note) }}</textarea>
                                        @error('note')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
