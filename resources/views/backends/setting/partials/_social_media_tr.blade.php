<tr class="tr_{{ $key }}">
    ...
    <td>
        ...
        <img src="{{ asset('images/no_image_available.jpg') }}" height="auto" width="60px" style="margin-bottom: 6px; cursor:pointer; border:none !important" alt="" class="avatar border social_media_icon social_media_icon_{{ $key }}">
