        ...
        @foreach (json_decode($social_medias, true) as $key => $row)
            <tr>
                ...
                <td>
                    ...
                    <img src="{{ $row['icon'] ? $row['icon'] : asset('images/no_image_available.jpg') }}" height="auto" width="60px" style="margin-bottom: 6px; cursor:pointer; border:none !important" alt="" class="avatar border social_media_icon social_media_icon_{{ $key }}">
