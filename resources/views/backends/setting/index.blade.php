                        ...
                        <div class="tab-pane fade active show" id="custom-tabs-four-home" role="tabpanel"
                            ...
                            <div class="card">
                                <div class="card-header">
                                    <div class="row">
                                        <div class="col-sm-6">
                                            <h3 class="card-title">{{ __('Measure') }}</h3>
                                        </div>
                                        <div class="col-sm-6">
                                            <button type="button" class="btn btn-primary float-right mb-3"
                                                data-toggle="modal" data-target="#createMeasureModal">
                                ...
                                <div class="card-body">
                                    @include('backends.setting.measure.index')
                                </div>
                            </div>
                        </div>
                        <div class="card">
                            <div class="card-header">
                                <div class="row">
                                    <div class="col-sm-6">
                                        <h3 class="card-title">{{ __('Payment Type') }}</h3>
                                    </div>
                                    <div class="col-sm-6">
                                        <button type="button" class="btn btn-primary float-right mb-3"
                                            data-toggle="modal" data-target="#createPaymentTypeModal">
                                            <i class="fa fa-plus-circle"></i> {{ __('Add New') }}
                                        </button>
                                    </div>
                                </div>
                            ...
                            <div class="card-body">
                                @include('backends.setting.paymenttype.index')
                            </div>
                        </div>
                        <div class="card">
                            <div class="card-header">
                                <div class="row">
                                    ...
                                    <div class="col-sm-6">
                                        <button type="button" class="btn btn-primary float-right mb-3"
                                            data-toggle="modal" data-target="#createCurrencyModal">
                                            <i class="fa fa-plus-circle"></i> {{ __('Add New') }}
                                        </button>
                                    </div>
                                </div>
                            ...
                            <div class="card-body">
                                @include('backends.setting.currency.index')
                            </div>
                        </div>
                        <div class="card">
                            <div class="card-header">
                            ...
                            <div class="card-body">
                                @include('backends.setting.exchangerate.index')
                            </div>
                        </div>
                    </div>
                </div>
