                                ...
                                <div class="row">
                                    <div class="form-group col-md-6 ">
                                        ...
                                        <input type="name" class="form-control @error('name') is-invalid @enderror"
                                            value="{{ old('name', $supplier->name)}}" name="name"
                                    ...
                                    <div class="form-group col-md-6 ">
                                        ...
                                        <input type="phone" class="form-control @error('phone') is-invalid @enderror"
                                            value="{{ old('phone', $supplier->phone)}}" name="phone"
                                        ...
                                        <div class="input-group">
                                            <div class="custom-file">
                                                ...
                                                <label class="custom-file-label"
                                                    for="exampleInputFile">{{ $supplier->image ?? __('Choose file') }}</label>
                                            </div>
                                        </div>
                                        <div class="preview text-center border rounded mt-2" style="height: 150px">
                                            <img src="
                                                @if ($supplier->image && file_exists(public_path('upload/suppliers/' . $supplier->image))) {{ asset('upload/suppliers/' . $supplier->image) }}
                                                @else
                                    ...
                                    <div class="form-group col-md-12">
                                        <label>{{ __('Note') }}</label>
                                        <textarea class="form-control @error('note') is-invalid @enderror" name="note">{{ old('note', $supplier->note )}}</textarea>
                                        @error('note')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
